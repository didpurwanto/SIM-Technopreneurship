            ...
            <div class="col-md-4 col-md-offset-4">
                <div class="login-panel panel panel-default">
                    ...
                    <div class="panel-body">
						...
						<tr>
							<td align="center">
								<h3 class="panel-title" ><a href="<?php echo base_url('index.php/page/update_password_doskarbem')?>" class="alert-link" align="center"><font color="#227594">Kembali</font></a></h3>                    
							</td>
						</tr>
						</table>
