            ...
            <div class="col-md-4 col-md-offset-4">
                <div class="login-panel panel panel-default">
                    <div class="panel-heading" align="center">
						<h2><font color="#003399"> Berhasil</font></h2>
                    </div>
                    <div class="panel-body">
                        
						<table  align="center">
						<tr>
							<td align="center"><font color="grey"><p>Pengajuan permohonan pengunduran diri berhasil. Pengajuan Anda sedang diproses.</p></font></p>
							</td>
						</tr>
						<tr>
							<td>&nbsp
						...
						<tr>
							<td align="center">
								<h3 class="panel-title" ><a href="<?php echo base_url('index.php/page/dashboard_mhs')?>" class="alert-link" align="center"><font color="#227594">Kembali</font></a></h3>                    
							</td>
						</tr>
