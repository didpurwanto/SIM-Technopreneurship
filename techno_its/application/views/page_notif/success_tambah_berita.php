            ...
            <div class="col-md-4 col-md-offset-4">
                <div class="login-panel panel panel-default">
                    ...
                    <div class="panel-body">
						...
						<table  align="center">
						<tr>
							<td align="center"><font color="grey"><p>Penambahan berita berhasil, silahkan cek di menu berita!</p></font></p>
							</td>
						</tr>
						<tr>
							<td>&nbsp
						...
						<tr>
							<td align="center">
								<h3 class="panel-title" ><a href="<?php echo base_url('index.php/page/dashboard')?>" class="alert-link" align="center"><font color="#227594">Kembali</font></a></h3>                    
							</td>
						</tr>
