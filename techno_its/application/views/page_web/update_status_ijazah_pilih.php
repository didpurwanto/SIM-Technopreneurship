...
<div class="row" style="background-color:#003399">
	<div class="col-lg-12" >
		...
		<h1><font color="white">Ubah Status Ijazah</font></h1>
	</div>
	<!-- /.col-lg-12 -->
</div>
<br />
<div class="col-lg-4" >
	...
	<form method="post" action="<?php echo base_url('index.php/page/update_status_ijazah_rekap')?>" name="myform" id="myform" enctype="multipart/form-data">
	<table>	
		<tr>
			<td width = "500px">
