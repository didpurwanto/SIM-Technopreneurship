...
<form method="post" action="<?php echo base_url('index.php/page/persetujuan_pengunduran_diri_rekap_pembimbing')?>" name="myform" id="myform" enctype="multipart/form-data">
<table>	
	<tr>
		<td width = "500px">
