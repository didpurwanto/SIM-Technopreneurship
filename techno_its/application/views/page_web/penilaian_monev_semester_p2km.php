...
<div class="jumbotron">
<form method="post" action="<?php echo base_url('index.php/page/penilaian_monev_semester_rekomendasi_p2km')?>" name="myform" id="myform" enctype="multipart/form-data">
	<table>
		<tr>
			<td width="500px">
	...
	<br />
	<a href="<?php echo base_url('index.php/page/penilaian_monev_rekap_semester_p2km')?>" type="submit" class="btn btn-primary">Kembali</button></a>
