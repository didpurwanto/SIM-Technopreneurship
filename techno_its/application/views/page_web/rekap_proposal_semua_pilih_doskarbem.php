...
<div class="row" style="background-color:#003399">
	<div class="col-lg-12" >
		...
		<h1><font color="white">Rekap Proposal yang Lolos</font></h1>
	</div>
	<!-- /.col-lg-12 -->
</div>
<br />
...
<div class="jumbotron">
<p>Silahkan pilih tahun dan skema pengajuan usaha<br /></p>

<form method="post" action="<?php echo base_url('index.php/page/rekap_proposal_semua_doskarbem')."/"."2015"."/"."1"?>" name="myform" id="myform" enctype="multipart/form-data">
<table>	
	<tr>
		<td width = "500px">
