...
<table  >
	<tr> 
		...
		<td width="220px"><input class="form-control" name="omset_1" placeholder="Tulis jumlah omsetnya">
		</td>
		<td width="9px">
		<td width="220px"><input class="form-control" name="keuntungan_1" placeholder="Tulis jumlah keuntungannya">
		</td>
	...
	<tr> 
		...
		<td width="220px"><input class="form-control" name="omset_2" placeholder="Tulis jumlah omsetnya">
		</td>
		<td width="9px">
		<td width="220px"><input class="form-control" name="keuntungan_2" placeholder="Tulis jumlah keuntungannya">
		</td>		
	</tr>
	<tr>
		<td>&nbsp
	...
	<tr> 
		...
		<td width="220px"><input class="form-control" name="omset_3" placeholder="Tulis jumlah omsetnya">
		</td>
		<td width="9px">
		<td width="220px"><input class="form-control" name="keuntungan_3" placeholder="Tulis jumlah keuntungannya">
		</td>
	</tr>
	<tr>
		<td>&nbsp
	...
	<tr> 
		...
		<td width="220px"><input class="form-control" name="omset_4" placeholder="Tulis jumlah omsetnya">
		</td>
		<td width="9px">
		<td width="220px"><input class="form-control" name="keuntungan_4" placeholder="Tulis jumlah keuntungannya">
		</td>
	</tr>
	<tr>
		<td>&nbsp
	...
	<tr> 
		...
		<td width="220px"><input class="form-control" name="omset_5" placeholder="Tulis jumlah omsetnya">		
		</td>
		<td width="9px">
		</td>
		<td width="220px"><input class="form-control" name="keuntungan_5" placeholder="Tulis jumlah keuntungannya">
		</td>
	</tr>
	<tr>
		<td>&nbsp
...
<table>		
	<tr>
		<td width = "800px">					
			...
			<textarea class="form-control" rows="2" name="aspek1_1" ></textarea>
			...
			<textarea class="form-control" rows="2" name="aspek1_2" ></textarea>
			...
			<textarea class="form-control" rows="2" name="aspek1_3" ></textarea>
	...
	<tr>
		<td width = "800px">					
			...
			<textarea class="form-control" rows="2" name="aspek2_1" ></textarea>
			...
			<textarea class="form-control" rows="2" name="aspek2_2" ></textarea>
			...
			<textarea class="form-control" rows="2" name="aspek2_3" ></textarea>
	...
	<tr>
		<td width = "800px">					
			...
			<textarea class="form-control" rows="2" name="aspek3_1" ></textarea>
			...
			<textarea class="form-control" rows="2" name="aspek3_2" ></textarea>
			...
			<textarea class="form-control" rows="2" name="aspek3_3" ></textarea>
	...
	<tr>
		<td width = "800px">					
			...
			<textarea class="form-control" rows="2" name="aspek4_1" ></textarea>
			...
			<textarea class="form-control" rows="2" name="aspek4_2" ></textarea>
			...
			<textarea class="form-control" rows="2" name="aspek4_3" ></textarea>
	...
	<tr>
		<td width = "800px">					
			...
			<textarea class="form-control" rows="2" name="aspek5_1" ></textarea>
			...
			<textarea class="form-control" rows="2" name="aspek5_2" ></textarea>
			...
			<textarea class="form-control" rows="2" name="aspek5_3" ></textarea>
	...
	<tr>
		<td width = "800px">					
			...
			<textarea class="form-control" rows="2" name="aspek6_1" ></textarea>
			...
			<textarea class="form-control" rows="2" name="aspek6_2" ></textarea>
			...
			<textarea class="form-control" rows="2" name="aspek6_3" ></textarea>
	...
	<tr>
		<td width = "800px">					
			...
			<textarea class="form-control" rows="2" name="aspek7_1" ></textarea>
			...
			<textarea class="form-control" rows="2" name="aspek7_2" ></textarea>
			...
			<textarea class="form-control" rows="2" name="aspek7_3" ></textarea>
	...
	<tr>
		<td width = "800px">					
			...
			<textarea class="form-control" rows="2" name="aspek8_1" ></textarea>
			...
			<textarea class="form-control" rows="2" name="aspek8_2" ></textarea>
			...
			<textarea class="form-control" rows="2" name="aspek8_3" ></textarea>
	...
	<tr>
		<td width = "800px">					
			...
			<textarea class="form-control" rows="2" name="aspek9_1" ></textarea>
	...
	<tr>
		<td width = "800px">					
			...
			<textarea class="form-control" rows="2" name="aspek10_3" ></textarea>
	...
	<tr>
		<td width = "800px">					
			...
			<textarea class="form-control" rows="2" name="aspek11_1" ></textarea>
			...
			<textarea class="form-control" rows="2" name="aspek11_2" ></textarea>
			...
			<textarea class="form-control" rows="2" name="aspek11_3" ></textarea>
	...
	<tr>
		<td width = "800px">					
			...
			<textarea class="form-control" rows="2" name="aspek12_1" ></textarea>
			...
			<textarea class="form-control" rows="2" name="aspek12_2" ></textarea>
			...
			<textarea class="form-control" rows="2" name="aspek12_3" ></textarea>
	...
	<tr>
		<td width = "800px">					
			...
			<textarea class="form-control" rows="2" name="aspek13_1" ></textarea>
			...
			<textarea class="form-control" rows="2" name="aspek13_2" ></textarea>
			...
			<textarea class="form-control" rows="2" name="aspek13_3" ></textarea>
	...
	<tr>
		<td width = "800px">					
			...
			<textarea class="form-control" rows="2" name="aspek14_1" ></textarea>
			...
			<textarea class="form-control" rows="2" name="aspek14_2" ></textarea>
			...
			<textarea class="form-control" rows="2" name="aspek14_3" ></textarea>
	...
	<tr>
		<td width = "800px">					
			...
			<textarea class="form-control" rows="2" name="aspek15_1" ></textarea>
	...
	<tr>
		<td width = "800px">					
			...
			<textarea class="form-control" rows="2" name="aspek16_1" ></textarea>
			...
			<textarea class="form-control" rows="2" name="aspek16_2" ></textarea>
			...
			<textarea class="form-control" rows="2" name="aspek16_3" ></textarea>
		...
		<tr>
			<td>
				<div class="form-group">
					...
					<label><i><font size="1px" color="brown"> File harus berekstensi .zip atau .rar max 3MB</font></i></label>
