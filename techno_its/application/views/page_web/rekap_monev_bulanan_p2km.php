...
<br />
<a href="<?php echo base_url('index.php/page/rekap_monev_bulanan_pilih_p2km')?>"> <font size="3px">&nbspKembali</font></a>
					...
					<table class="table table-striped table-bordered table-hover" id="dataTables-example">
						...
						<tbody>
							<tr>
								...
								<td align="center">
								<form role="form" method="post" action="<?php echo base_url('index.php/page/rekap_monev_bulanan_detail_p2km')?>">
