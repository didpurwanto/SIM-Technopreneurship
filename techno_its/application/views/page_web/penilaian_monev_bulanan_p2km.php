...
<div class="jumbotron">
<form method="post" action="<?php echo base_url('index.php/page/penilaian_monev_bulanan_rekomendasi_p2km')?>" name="myform" id="myform" enctype="multipart/form-data">
	<table>
		<tr>
			<td width="500px">
	...
	<br />
	<a href="<?php echo base_url('index.php/page/penilaian_monev_rekap_bulanan_p2km')?>" type="submit" class="btn btn-primary">Kembali</button></a>
