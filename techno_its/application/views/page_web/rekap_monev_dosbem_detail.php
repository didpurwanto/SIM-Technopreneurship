...
<hr />
	...
	<hr />
	<h2><b>TOTAL NILAI : <?php echo "30"?></b></h2>
	...
	<table >		
		<tr>
			...
			<td><h4><font color="green">BISA DILANJUTKAN</font><h4>
			</td>
		</tr>
		<tr>
			<td width="200px">		
	...
	<a href="<?php echo base_url('index.php/page/rekap_monev_pilih_dosbem')?>" type="button" class="btn btn-primary">Kembali</button></a>
