...
<table >		
	...
	<tr>
		<td width = "800px">					
			...
			<textarea class="form-control" rows="5" name="kendala" readOnly="true" ><?php echo $catatan_dan_saran_pembimbing?></textarea>
	...
	<tr>
		<td width = "800px">					
			<label><br />Saran dan Catatan Tim POKJA dan P2KM</label> 
