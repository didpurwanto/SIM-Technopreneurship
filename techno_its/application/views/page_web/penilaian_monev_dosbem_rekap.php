...
<br />
<a href="<?php echo base_url('index.php/page/penilaian_monev_pilih_dosbem')?>"> <font size="3px">&nbspKembali</font></a>
					...
					<table class="table table-striped table-bordered table-hover" id="dataTables-example">
						...
						foreach($rekap as $rows)
						{
							...
							echo "<tr>";
								...
								echo "<a href=\"".base_url('index.php/page/penilaian_monev_dosbem_detail')."/".$rows['id_pengaju_proposal']."/".$rows['periode_monev']."\"type=\"submit\" class=\"btn btn-primary\">Lihat Detail</a>";
								echo "</td>";	
							echo "</tr>";
