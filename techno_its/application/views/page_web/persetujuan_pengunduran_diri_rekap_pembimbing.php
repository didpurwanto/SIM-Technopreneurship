...
<br />
<a href="<?php echo base_url('index.php/page/persetujuan_pengunduran_diri_pilih_pembimbing')?>"> <font size="3px">&nbspKembali</font></a>
					...
					<table class="table table-striped table-bordered table-hover" id="dataTables-example">
						...
						<tbody>
							<tr>
								...
								<td align="center">
								<form role="form" method="post" action="<?php echo base_url('index.php/page/persetujuan_pengunduran_diri_detail_pembimbing')?>">
