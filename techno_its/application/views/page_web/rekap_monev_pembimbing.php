...
<br />
<a href="<?php echo base_url('index.php/page/rekap_monev_pilih_pembimbing')?>"> <font size="3px">&nbspKembali</font></a>
					...
					<table class="table table-striped table-bordered table-hover" id="dataTables-example">
						...
						foreach($rekap as $rows)
						{
							...
							echo "<tr>";
								...
								echo "<a href=\"".base_url('index.php/page/rekap_monev_pembimbing_detail')."/".$rows['id_pengaju_proposal']."/".$rows['periode_monev']."\"type=\"submit\" class=\"btn btn-primary\">Lihat Detail</a>";
								echo "</td>";	
							echo "</tr>";
