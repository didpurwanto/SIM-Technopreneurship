...
<br />
<a href="<?php echo base_url('index.php/page/review_monev_bulanan_pilih_pembimbing')?>"> <font size="3px">&nbspKembali</font></a>
					...
					<table class="table table-striped table-bordered table-hover" id="dataTables-example">
						...
						<tbody>
							...
							foreach($result as $data)
							{
								...
								echo "<form role=\"form\" action=\"".base_url('index.php/page/review_monev_bulanan')."/".$data['id_pengaju_proposal']."/".$periode."/\"> ";												
