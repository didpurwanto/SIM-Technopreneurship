...
<div class="jumbotron">
<form method="post" action="<?php echo base_url('index.php/notif/success_penilaian_monev_semester_p2km')?>" name="myform" id="myform" enctype="multipart/form-data">
	...
	<table >		
		<tr>
			<td>		
				<h4>Rekomendasi Sistem : <font color="red"><?php echo "Ditutup"?></font></h4>				
			</td>
		</tr>	
		<tr>
			<td>		
...
<br />
<a href="<?php echo base_url('index.php/page/penilaian_monev_semester_p2km')?>" type="submit" class="btn btn-primary">Kembali</button></a>
