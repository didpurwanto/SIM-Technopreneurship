            ...
            <div class="col-md-4 col-md-offset-4">
                <div class="login-panel panel panel-default">
                    ...
                    <div class="panel-body">
                        <form role="form" action="<?php echo base_url("index.php/akun/login_doskarbem_action")?>" method="post">
                            <fieldset align="center">
                                <div class="form-group">
                                    <input class="form-control" placeholder="ID Pengguna" name="id_pengguna" type="text" autofocus>
                                </div>
                                <div class="form-group">
